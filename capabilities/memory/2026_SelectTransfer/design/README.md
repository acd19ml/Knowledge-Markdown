...
Stable design documents that define the project's motivation, scope, and constraints.
These files change rarely after initial drafting.

| File | Role |
|---|---|
| [project-positioning.md](project-positioning.md) | Three-level positioning: high / mid / low; failure taxonomy; why this not that |
