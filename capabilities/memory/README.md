...
Agent 如何记住：信息的存储、组织、检索与淘汰。

涵盖认知类型（感知/工作/情节/语义/程序性记忆）、存储基底（内部参数 vs 外部数据库）、单/多 Agent 记忆操作。
...
- [2024_AWM/](./2024_AWM/) — AWM 复现与实验材料
- [2026_Epi2Lesson/](./2026_Epi2Lesson/) — 当前 active memory research project
