<img src="../images/CogVLM_md_images/figures/radar_compare_202401.pdf.png"  />
**Figure 1.** The performance of CogVLM on a broad range of multi-modal tasks in comparison with existing approaches.

# Introduction

<img src="../images/CogVLM_md_images/figures/CogVLM_demo_all_icml.pdf.png"  />
...
<div class="minipage">
<img src="../images/CogVLM_md_images/figures/mmlu.png" />
<div class="minipage">
<img src="../images/CogVLM_md_images/figures/cogvlm.png" />
...
**Table 1.** Image captioning benchmark results.
...
**Table 2.** Visual question answering and LVLM benchmark results.
...
**Table 5.**
**Table 6.** Multitask training hyperparameter settings.
...
<div class="center">
<img src="../images/CogVLM_md_images/figures/tdiuc.pdf.png" style="width:60.0%"  />
...
The experimental results on TDIUC compare our model against the specialist SOTA method MUREL  are shown in Figure 4. From the experimental result, we can see that our model consistently outperforms the previous model on 12 specific question types, resulting in a $`94.0`$ accuracy score compared to the previous SOTA of $`88.2`$ on the overall dataset. These results demonstrate that our model exhibits comprehensive problem-solving skills on general VQA tasks.
