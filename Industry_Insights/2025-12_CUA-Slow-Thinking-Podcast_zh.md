...
| **谢天宝** | 港大博士 / OSWorld 核心作者 | 基准测试、评估方法论 |
...
**为什么重要**：大多数已发表的基准测试衡量的是 0→60 的性能。一个在 OSWorld 上得 70% 的模型在生产环境中仍可能完全无法使用，因为剩余的 30% 恰好包含用户最在意的场景（安全提示、意外的 UI 变化、多步错误恢复）。
...
**测试时训练（TTT）**：在推理时基于新观察更新模型权重，无需完整的微调周期。
...
| 主题 | 相关文件 |
|---|---|
| 自演化智能体（学习/记忆） | [Self_Evolve_zh/03_env-centric/3.2_dynamic-experience.md](../Self_Evolve_zh/03_env-centric/3.2_dynamic-experience.md) |
| 持续学习 / 终身记忆 | [Agent_Memory_zh/04_learning-policy.md](../Agent_Memory_zh/04_learning-policy.md) |
| 基准测试（OSWorld、WebArena 等） | [Self_Evolve_zh/07_benchmarks.md](../Self_Evolve_zh/07_benchmarks.md) |
| 知识表征（程序记忆） | [Agent_Memory_zh/02_taxonomy/2.2_cognitive-mechanisms.md](../Agent_Memory_zh/02_taxonomy/2.2_cognitive-mechanisms.md) |
| 模块化架构 / 工具使用 | [Self_Evolve_zh/03_env-centric/3.3_modular-arch.md](../Self_Evolve_zh/03_env-centric/3.3_modular-arch.md) |
| 模型崩溃挑战 | [Self_Evolve_zh/06_challenges.md](../Self_Evolve_zh/06_challenges.md) |
| 智能体拓扑（多智能体） | [Self_Evolve_zh/03_env-centric/3.4_agentic-topology.md](../Self_Evolve_zh/03_env-centric/3.4_agentic-topology.md) |
| Claude Code 作为智能体系统 | [Self_Evolve_zh/05_applications.md](../Self_Evolve_zh/05_applications.md) |
